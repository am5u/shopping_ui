...
class TTexts {
  ...
  static String get tContinue => "continue".tr();
  static String get Languge => "Language".tr();

  static String get HomeString => "HomeString".tr();
  static String get CoursesString => "CoursesString".tr();
  static String get WishlistString => "WishlistString".tr();
  static String get ProfileString => "ProfileString".tr();
  // -- OnBoarding Texts
